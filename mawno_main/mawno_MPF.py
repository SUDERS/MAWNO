...
from config_MPF import Config as config
...
class train:
    ...
    def ode_gradient(self, x, y):
        ...
        return u_t - (self.config.params.k_1_ / self.config.params.G - (self.config.params.k_2_ + self.config.params.k_2__ * u ** 2 + self.config.params.k_Wee) * u + (
            self.config.params.k_25_ + self.config.params.k_25__ * u ** 2) * (
            v / self.config.params.G - u)), v_t - (self.config.params.k_1_ - (self.config.params.k_2_ + self.config.params.k_2__ * u ** 2) * v)
